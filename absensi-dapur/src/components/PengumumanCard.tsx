...
export default function PengumumanCard() {
  ...
  // Hanya tampilkan yang belum dibaca — begitu ditandai dibaca, langsung hilang.
  const unread = list.filter((p) => !p.dibaca);
  ...
  return (
    <div className="card overflow-hidden">
      ...
      <ul className="divide-y divide-white/5">
        {unread.map((p) => (
          <li key={p.id} className="bg-gold-500/5 px-4 py-3">
