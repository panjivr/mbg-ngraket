  ...
  return [
    { key: "dash", label: "Dashboard", solo: { label: "Dashboard", href: "/admin", exact: true, show: f.fullAdmin } },
    {
      ...
      items: [
        ...
        { label: "🍱 Menu", href: "/admin/menu", show: (f.aksesDistribusi || f.aksesGizi) && has("distribusi") },
        { label: "📅 Jadwal & Belanja", href: "/admin/jadwal-menu", also: ["/admin/belanja"], show: (f.aksesDistribusi || f.aksesGizi) && has("distribusi") },
