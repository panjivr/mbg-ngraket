# AGENTS.md — Konteks untuk Codex

Dokumen ini otomatis dibaca Codex saat kamu jalankan `Codex` di root repo. Isinya menjelaskan arsitektur, konvensi, dan cara jalanin proyek supaya Codex bantu ngoding tanpa harus nebak.
...
- Branch fitur: gunakan pola `Codex/<nama-fitur>` atau `feat/<nama>` — Vercel auto-buat preview deployment
